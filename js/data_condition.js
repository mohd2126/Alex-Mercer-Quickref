data_condition = [
    ...
    },
    {
        ...
        bullets: [
            "•	A paralyzed creature is dazed and cannot concentrate on a spell.<br>•	Attack Rolls against the creature have Advantage.<br>•	The creature has Disadvantage on attack rolls.<br>•	The creature automatically fails Strength and Dexterity saving throws.<br>•	The creature can only make one Attack per turn.<br>•	If the creature attempts to cast a spell with a casting time of 1 action, roll a d20. On an 11 or higher, the spell does not take effect until the creature’s next turn, and the creature must use its action on that turn to complete the spell. If it cannot, the spell is wasted.<br>•	Any attack that hits the creature is a critical hit if the attacker is within 5 feet of the creature."            
        ]
    },
    {
        title: "Petrified",
    ...
    },
    {
        ...
        reference: "Alex Mercer homebrew",
        bullets: [
            "•	A stunned creature is dazed and cannot concentrate on a spell.<br>•	Attack Rolls against the creature have Advantage.<br>•	The creature has Disadvantage on attack rolls.<br>•	The creature has Disadvantage on Strength and Dexterity saving throws.<br>•	The creature has Disadvantage on ability checks.<br>•	The creature can only make one Attack per turn.<br>•	If the creature attempts to cast a spell with a casting time of 1 action, roll a d20. On an 11 or higher, the spell does not take effect until the creature’s next turn, and the creature must use its action on that turn to complete the spell. If it cannot, the spell is wasted."
        ]
    },
    {
        title: "Unconscious",
    ...
    },
    {
        ...
        reference: "PHB, pg. 197. + Alex Mercer homebrew",
        bullets: [
    ...
    },
    {
        ...
        reference: "Alex Mercer Homebrew",
        bullets: [
            "A dazed creature can move or take one action on its turn, not both; It also cannot take a Bonus Action or a Reaction."
        ]
    },
    {
        title: "Slowed [N]",
        ...
        reference: "Alex Mercer Homebrew",
        bullets: [
            "•	A slowed creature must spend 1 extra foot of movement for every foot it moves using its Speed.<br>•	Attack Rolls against the creature have Advantage.<br>•	The creature has Disadvantage on Dexterity Saving Throws."
        ]
    }
]
